...
export const getCustomers = (): Promise<ServiceLayerResponse<Customer>> => {
...
export const getCustomerById = (id: string): Promise<ServiceLayerResponse<Customer>> => {
  return new Promise((resolve, reject) => {
    readCustomerById(id)
...
export const getCustomerByName = (name: string): Promise<ServiceLayerResponse<Customer>> => {
  return new Promise((resolve, reject) => {
...
export const postCustomer = (body: Customer): Promise<ServiceLayerResponse<Customer>> => {
  return new Promise((resolve, reject) => {
...
export const putCustomer = (id: string, body: Customer): Promise<ServiceLayerResponse<Customer>> => {
  return new Promise((resolve, reject) => {
...
export const deleteCustomer = (id: string): Promise<ServiceLayerResponse<Customer>>  => {
  return new Promise((resolve, reject) => {
